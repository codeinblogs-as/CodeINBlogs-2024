              ...
              <TextureCardStyled>
                ...
                <TextureCardContent>
                    ...
                    <TextureButton variant="icon">
                      ...
                      >
                        <path
                          ...
                          fill="#545454"
                        />                            </svg>
                      <strong className="pl-2 text-zinc-300">Github</strong>
                    </TextureButton>
                  </div>
                  ...
                  <form ref={formRef} className="flex flex-col gap-6">
                    <div>
                      <Label htmlFor="email">Usrname or Email</Label>
                      <Input
                        id="email-username"
                        type="email"
                        required
                  ...
                  <div className="flex flex-col items-center justify-center">
                    <div className="py-2 px-2">
                      <div className="text-center text-xs">
                        Secured by <Link href="https://appwrite.io"><b>Appwrite.io</b></Link>
                      </div>
                    </div>
                  </div>
                </div>
