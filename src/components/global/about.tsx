        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1 duration-150" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    ...
                    <div className="flex-1 mt-5 mx-auto sm:w-9/12 lg:mt-0 lg:w-auto">
                        <div className="relative rounded-2xl overflow-hidden w-full"> {/* Ensure both containers have 'w-full' for full width */}
                            <Image
                                src={AboutImg}
                                alt=""
                                width={400}  // Adjust width as needed
                                height={200} // Adjust height as needed
                                className="object-cover w-full h-full transition duration-300" // Ensure the Image covers the container and adjusts with it
                            />
